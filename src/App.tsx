...
import TubeClosedDNA from "./images/tubecloseddna.png"
...
import FreezerClosed from "./images/freezerClosed.png"
import FreezerEmpty from "./images/freezerEmpty.png"
import FreezerFilled from "./images/freezerFilled.png"
import TrayEmpty from "./images/trayEmpty.png"
import TrayFilled from "./images/trayFilled.png"
        ...
        <div className="row" style={{ height: "100%" }}>
          <div className="col-4" style={{ backgroundColor: "rgba(0,0,0,0.53)", height: "100%" }}>
            <p style={{
              ...
              color: "white", fontWeight: "bold", fontSize: "18pt",
              lineHeight: "3rem"
            }}>Praktikan melakukan isolasi DNA untuk beberapa tujuan, seperti:</p>
            <ul style={{
              paddingTop: "6rem",
              color: "white", fontWeight: "bold", fontSize: "18pt",
              lineHeight: "3rem"
      ...
      <div id="zoom-container" className="world-wrapper zoom-center" style={{
        ...
        <div className="world-wrapper"
          ...
          <div style={{
            ...
            <div style={{ position: "absolute", top: "-0.55rem", left: "-0.65rem", zIndex: 2000 }}>
              <Link to="/page5"><img src={Next} id="backButton" style={{
                transform: "rotate(180deg)",
            ...
            <p className="text-label" style={{ width: "10rem", bottom: "14.5rem", left: "3.75rem", opacity: 1 }}>
              Praktikan mengambil sampel dengan cara menggosok pipi bagian dalam menggunakan buccal swab</p>
        ...
        <div className="world-wrapper"
          ...
          <div style={{
            ...
            <p id="instruksi" className="text-label" style={{ width: "10rem", bottom: "14.5rem", left: "3.75rem", opacity: 0 }}>
              Tahap ini praktikan harus menggunting ujung swab agar tabung tertutup</p>
            <img id="swab" src={SwabCells} className="swab-first" style={{
              left: "2.5rem",
              top: "-4.75rem",
              transform: "rotate(0)",
      ...
      <div id="canvas" className="world-wrapper zoom-center zoom-out" style={{
        ...
        <div className="world-wrapper"
          ...
          <div style={{
            ...
            <div id="backButton" style={{ display: "none", position: "absolute", top: "4.95rem", left: "29rem", zIndex: 10002 }}>
      ...
      <div id="canvas" className="world-wrapper zoom-center" >
        <div className="world-wrapper"
          ...
          <div style={{
            ...
            <div id="backButton" style={{ display: "none", position: "absolute", top: "9.95rem", left: "-12rem", zIndex: 10002 }}>
              <Link to="/page8"><img src={Next} style={{
                transform: "rotate(180deg)",
            ...
            <p id="instruksi" className="text-label" style={{ width: "10rem", bottom: "14.5rem", left: "3.75rem", opacity: 0 }}>
              Selanjutnya, praktikan mengeluarkan buccal swab dari tabung</p>
            <img id="arrow" src={Arrow} style={{
              left: "0.5rem",
              top: "-9.5rem",
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        ...
        $('#tubeClosed').draggable({
          ...
          drag: function () {
            if (isOverlap("#centrifuge-hitbox", "#tubeClosed")) {
              ...
              setTimeout(() => {
                ...
                setTimeout(() => {
                  ...
                  $('#tubeClosed2').draggable({
                    ...
                    drag: function () {
                      if (isOverlap("#centrifuge-hitbox", "#tubeClosed2")) {
                        $("#centrifuge-hitbox").css({ display: 'none' });
                        $('#tubeClosed2').css({
                          transition: "transform 0s ease",
                          transform: "rotate(0)"
                                        ...
                                        setTimeout(() => {
                                          ...
                                          $("#nextButton").click(() => {
                                            ...
                                            setTimeout(() => {
                                              ...
                                              $("#instruksi").text("Praktikan memisahkan untaian DNA dari endapan protein ke tube kosong.")
                                              $('#instruksi').css({
                                                display: "block",
                                                bottom: "28.5rem",
                                                left: "15.75rem",
                                                    ...
                                                    if (isOverlap("#pipetSingle", "#tubeOpen-hitbox")) {
                                                      ...
                                                      setTimeout(() => {
                                                        ...
                                                        setTimeout(() => {
                                                          ...
                                                          $("#instruksi").text("Praktikan harus menambahkan isopropil alcohol ke dalam tabung DNA sampel.")
                                                        }, 3500)
                                                      }, 1500)
                                                    }
                                                  }
      ...
      <div id="canvas" className="world-wrapper zoom-center" style={{
        ...
        <div className="world-wrapper"
          ...
          <div id="tubeClosed2-hitbox" style={{
            ...
            height: "3rem",
            display: "block",
            width: '4rem', backgroundColor: "red"
          }}></div>
          ...
          <div id="centrifuge-hitbox" style={{
            ...
            height: "7.3rem",
            display: "none",
            width: '9rem', backgroundColor: "red"
          }}></div>
          ...
          <div id="backButton" style={{ display: "none", position: "absolute", top: "39.95rem", left: "15rem", zIndex: 10002 }}>
            <Link to="/page9"><img src={Next} style={{
              transform: "rotate(180deg)",
              width: '3.5rem', height: "auto"
            }}></img></Link>
          </div>
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              $('#tubeClosedna').draggable({
                ...
                drag: function () {
                  if (isOverlap("#centrifuge-hitbox", "#tubeClosedna")) {
                    $('#tubeClosedna').draggable("destroy");
                    $('#centrifuge-hitbox').css({
                      display: "none",
                    })
                    setTimeout(() => {
                                  ...
                                  if (isOverlap("#pipetSingle", "#tubeOpen-hitbox")) {
                                    ...
                                    setTimeout(() => {
                                      ...
                                      $("#tubeClosedna").css({
                                        left: "15.75rem",
                                        top: "32rem",
                                        transform: "scale(7.25) rotate(67deg)"
                                      })
                                      $("#canvas").css({
                                        ...
                                        $("#nextButton2").click(() => {
                                          ...
                                          setTimeout(() => {
                                            ...
                                            $("#tubeClosedna").css({
                                              left: "15.75rem",
                                              top: "37rem",
                                              transform: "scale(2) rotate(67deg)"
                                            })
                                            $("#instruksi").css({
                                              opacity: 1,
                                              bottom: "28.5rem",
                                            ...
                                            $("#instruksi").text("Masukkan tabung ke tray kemudian simpan ke dalam freezer.")
                                            $('#tubeClosedna').draggable({
                                              start: function () {
                                                $("#tubeClosedna").css({
                                                  transition: "none"
                                              ...
                                              drag: function () {
                                                if (isOverlap("#tray", "#tubeClosedna")) {
                                                  $("#tray").attr({
                                                    src: TrayFilled
                                                  })
                                                  $("#tubeClosedna").css({
                                                    ...
                                                    drag: function () {
                                                      if (isOverlap("#freezer", "#tray")) {
                                                        ...
                                                        setTimeout(() => {
                                                          ...
                                                          $("#instruksi").text("Selamat! Kamu telah menyelesaikan simulasi ini.")
    ...
    <div className="container global-container" id="content">
      <div id="canvas" className="world-wrapper zoom-center" style={{
        ...
        <div className="world-wrapper"
          ...
          <img src={TrayEmpty} id="tray" style={{
            position: "absolute", left: "35rem", top: "38rem",
            zIndex: 100,
            width: '12rem', height: "auto", opacity: 0
          }}></img>
          <img src={FreezerEmpty} id="freezer" style={{
            position: "absolute", left: "50rem", top: "18rem",
            zIndex: 50,
            width: '24rem', height: "auto", opacity: 0
          }}></img>
          ...
          <div id="backButton" style={{ display: "none", position: "absolute", top: "43.95rem", left: "2rem", zIndex: 10002 }}>
            <Link to="/page10"><img src={Next} style={{
              transform: "rotate(180deg)",
              width: '3.5rem', height: "auto"
            }}></img></Link>
          </div>
          ...
          <div id="nextButton2" style={{ display: "none", position: "absolute", top: "43.95rem", left: "36rem", zIndex: 10002 }}>
            <img src={Next} style={{
              width: '3.5rem', height: "auto"
            }}></img>
          </div>
          <div id="backButton2" style={{ display: "none", position: "absolute", bottom: "1rem", left: "4rem" }}>
            <Link to="/page10"><img src={Next} style={{
              transform: "rotate(180deg)",
              width: '5rem', height: "auto"
            }}></img></Link>
          </div>
          <div id="nextButton3" style={{ display: "none", position: "absolute", bottom: "1rem", right: "4rem" }}>
            <Link to="/"><img src={Next} style={{
              width: '5rem', height: "auto"
            }}></img></Link>
          </div>
        </div>
